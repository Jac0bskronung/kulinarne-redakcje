...
export const ExpenseCard = ({ icon: Icon, name, amount, category, color = 'green', date, delay = 0, onEdit, onDelete }) => {
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-4 p-4 rounded-lg bg-[#151A23] border border-white/5 hover:border-white/10 transition-colors duration-300 cursor-default group"
